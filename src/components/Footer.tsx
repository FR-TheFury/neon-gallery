        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-300 hover:text-neon-purple transition-colors">
              ...
              <a href="https://www.instagram.com/himely_puppyvrc/" className="text-gray-300 hover:text-neon-purple transition-colors">
